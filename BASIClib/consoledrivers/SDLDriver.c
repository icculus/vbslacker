...
static void __sdlcon_deinitConsoleDriver(void);
static void __sdlcon_printNChars(const __byte *str, __long n);
static void __sdlcon_printNewLine(void);
static void __sdlcon_vbpii_viewPrint(__integer topRow, __integer botmRow);
static void __sdlcon_vbp_viewPrint(void);
static void __sdlcon_vbp_cls(void);
static __integer __sdlcon_vbi_csrline(void);
static __integer __sdlcon_vbia_pos(void *pVar);
static void __sdlcon_vbpiii_color(__integer fore,
                                 __integer back,
                                 __integer bord);
static void __sdlcon_vbpil_color(__integer fore, __long feh);
static void __sdlcon_vbpi_color(__integer fore);
static void __sdlcon_vbpii_locate(__integer newY, __integer newX);
static void __sdlcon_vbpNi_locate(__integer newX);
static void __sdlcon_vbpiN_locate(__integer newY);
static void __sdlcon_vbp_locate(void);
static void __sdlcon_vbpif_sound(__integer frequency, __single duration);
static void __sdlcon_vbp_beep(void);
static void __sdlcon_getConsoleDriverName(__byte *buffer, __integer size);

static __vbConsoleEntries directConEntries =
{
    __sdlcon_getConsoleDriverName,
    __sdlcon_deinitConsoleDriver,
    __sdlcon_printNewLine,
    __sdlcon_printNChars,
    __sdlcon_vbpii_viewPrint,
    __sdlcon_vbp_viewPrint,
    __sdlcon_vbp_cls,
    __sdlcon_vbi_csrline,
    __sdlcon_vbia_pos,
    __sdlcon_vbpiii_color,
    __sdlcon_vbpil_color,
    __sdlcon_vbpi_color,
    __sdlcon_vbpii_locate,
    __sdlcon_vbpNi_locate,
    __sdlcon_vbpiN_locate,
    __sdlcon_vbp_locate,
    __sdlcon_vbpif_sound,
    __sdlcon_vbp_beep
};
...
static __boolean __sdlcon_openConsole(void)
/*
...
static void __sdlcon_vbp_beep(void)
{
    __sdlcon_vbpif_sound(750, 5.0 * 18.2); /* !!! test. */
} /* __sdlcon_vbp_beep */
...
static void __sdlcon_vbpiii_color(__integer fore, __integer back,
...
//    __sdlcon_vbpii_color(fore, back);
} /* __sdlcon_vbpiii_color */
...
static int  __sdlcon_openConsole(void) { return(-1); }
static void __sdlcon_deinitConsoleDriver(void) {}
static void __sdlcon_printNChars(char *str, int n) {}
static void __sdlcon_vbp_cls(void) {}
static void __sdlcon_vbpiii_color(__integer fore, __integer back, __integer bord) {}
static void __sdlcon_printNewLine(void) {}
static void __setCursorXY(__integer _x, __integer _y) {}
static void __sdlcon_vbp_beep(void) {}
static void __sdlcon_vbpif_sound(__integer frequency, __single duration) {}
...
static void __sdlcon_vbpii_viewPrint(__integer top, __integer bottom)
/*
...
static  __integer __sdlcon_vbia_pos(__attribute__ ((unused)) void *pVar)
/*
...
static void __sdlcon_vbpil_color(__attribute__ ((unused)) __integer fore,
 ...
 */
{
    __boolean retVal = __sdlcon_openConsole();
